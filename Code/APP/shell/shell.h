 ...
 * @param ... 代理参数
 */
#define SHELL_EXPORT_CMD_AGENCY(_name, _func, _desc, ...) \
        SHELL_AGENCY_FUNC(_func, ##__VA_ARGS__) \
        SHELL_EXPORT_CMD(_name, SHELL_AGENCY_FUNC_NAME(_func), _desc)
 ...
 * @param ... 代理参数
 */
#define SHELL_EXPORT_CMD_AGENCY_EX(_name, _func, _desc, _help, ...) \
        SHELL_AGENCY_FUNC(_func, ##__VA_ARGS__) \
        SHELL_EXPORT_CMD_EX(_name, SHELL_AGENCY_FUNC_NAME(_func), _desc, _help)
